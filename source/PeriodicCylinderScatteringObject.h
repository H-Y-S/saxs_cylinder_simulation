...
#ifndef _PERIODIC_CYLINDER_SCATTERING_OBJECT_H
#define _PERIODIC_CYLINDER_SCATTERING_OBJECT_H

using namespace std;

#include "ScatteringObject.h"

class PeriodicCylinderScatteringObject : public ScatteringObject {
 public:
    ~PeriodicCylinderScatteringObject() {};
...
#endif // _PERIODIC_CYLINDER_SCATTERING_OBJECT_H
